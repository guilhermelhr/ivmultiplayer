...
void CCrashFixes::Apply()
{
	...
	CPatcher::InstallJmpPatch((CGame::GetBase() + 0x625F15), (DWORD)CRASH_625F15_HOOK /*(GetBase() + 0x625F1D)*/);
	...
	*/
	CPatcher::InstallRetnPatch(CGame::GetBase() + 0x8F2F40);
}
